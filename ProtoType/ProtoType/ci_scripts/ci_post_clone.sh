...
#
# This script must live in a `ci_scripts` folder in the SAME directory as the
# Xcode project (ProtoType/ProtoType/ProtoType.xcodeproj) for Xcode Cloud to run
# it. A `ci_scripts` folder at the repo root is ignored.
